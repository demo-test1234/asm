...
checkpoint_file = './aigcpanelmodels/dwpose/dw-ll_ucoco_384.pth'
...
def read_imgs(img_list):
    ...
    for img_path in tqdm(img_list, ascii=True):
...
def get_landmark_and_bbox(img_list,upperbondrange =0):
    ...
    coords_list = []
    landmarks = []
    print('get_landmark_and_bbox start', upperbondrange)
    average_range_minus = []
    average_range_plus = []
    for fb in tqdm(batches, ascii=True):
